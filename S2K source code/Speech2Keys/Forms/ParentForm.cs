			...
			if (command != null)
		    	{
		    		...
		    		logTextBox.AppendText("NAME: "+command.name+Environment.NewLine);
		    		...
		    		logTextBox.AppendText("KEYPHRASES: " + Environment.NewLine);
		    		foreach (var k in command.keyPhrases)
		    			logTextBox.AppendText(k+Environment.NewLine);
		    		logTextBox.AppendText("USING STANDARD PHRASES: ");
		    		if (command.useStandardResponses)
		    			logTextBox.AppendText("yes " + Environment.NewLine);
		    		else
		    			logTextBox.AppendText("no " + Environment.NewLine);
		    		logTextBox.AppendText("RESPONSES: " + Environment.NewLine);
		    		if (command.responses.Count >= 10)
		    			...
		    			foreach (var r in command.responses)
		    				logTextBox.AppendText(r+Environment.NewLine);
		    	}
