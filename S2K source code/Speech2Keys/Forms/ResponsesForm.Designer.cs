...
namespace Speech2Keys
{
	partial class ResponsesForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Enter Response(s)." + Environment.NewLine+"Hit \'del\' key to delete selected responses.";
			// 
			// responsesTextBox
			// 
			...
			// 
			this.standardResponsesCheckBox.Location = new System.Drawing.Point(179, 23);
			this.standardResponsesCheckBox.Name = "standardResponsesCheckBox";
			this.standardResponsesCheckBox.Size = new System.Drawing.Size(94, 36);
